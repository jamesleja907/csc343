...
\item   % ----------
The receiver (Message[to]) of a message must be either a user (User[uid]) or a group (Group[gid]).
...
\item %----------
The total size of all attachments in a message must be less than 128MB.
